...
理解本文能保证你写出正确的二分查找的代码，但实际题目中不会直接让你写二分代码，我会在 [二分查找的变体](https://appktavsiei5995.pc.xiaoe-tech.com/detail/i_62a07736e4b01a485209b0b4/1) 和 [二分查找的运用](./../高频面试系列/二分运用.md) 中进一步讲解如何把二分思维运用到更多算法题中。
...
<summary><strong>引用本文的文章</strong></summary>
 ...
 - [【强化练习】二分搜索算法经典习题](https://labuladong.gitee.io/article/fname.html?fname=二分题目)
 - [丑数系列算法详解](https://labuladong.gitee.io/article/fname.html?fname=丑数)
